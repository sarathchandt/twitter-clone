...
import './UserTweetView.css'

function UserTweetView() {
            ...
            <div className="row large-2">
                <div className="col-12">
                    <div className="w-full bg-[#16181c] rounded-4 text-backgroundLogin pb-1 h-auto mt-5">
                        ...
                        {myTweet.length == 0 ? <div className='flex justify-center my-5x' > please add tweets</div> :
                            myTweet.map(tweet => {
                                return <>
                                    <div className=" my-3">
